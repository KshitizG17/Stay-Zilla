...
<div class="modal fade" id="loginModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="mb-4">
            ...
            <button type="button" class="btn btn-outline-dark shadow-none p-0" data-bs-toggle="modal" data-bs-target="#forgotModal" data-bs-dismiss="modal">
                    Forgot Password?
            </button>
            </div>
        </div>
            ...
            <form id="register-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input name="profile" type="file" accept=".jpg, .png, .jpeg, .webp"class="form-control shadow-none" required>
                        </div>
                    ...
                    <button type="submit" class="btn btn-dark shadow-done">REGISTER</button>
                    </div>
                </div>
            </form>
        </div>
